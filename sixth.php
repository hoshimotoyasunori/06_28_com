...
$str6 = '';                                  // 出力用の空の文字列
$file6 = fopen('data/sixth.txt', 'r');        // ファイルを開く(読み取り専用) 
flock($file6, LOCK_EX); // ファイルをロック
...
<body>
    ...
    <div id="sixth">
        <form action="roku.php" method="post">
            <fieldset id="in">
                <legend style="background-color:#ffa500; ">目標6</legend>
                <div>
            ...
            <div id="submit">
                <div>
                    <input type="text" id="mandara_main" placeholder="目標6">
